...
class LingVisSDK(val navigatorFragment: EpubNavigatorFragment?, val context: Context, val publication: Publication?) {
    ...
    companion object {
        fun prepare(clientId: String, version: String, app: String, clientData: String, server: Server) {
            LingVisSDK.app = app
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                withContext(Dispatchers.IO) {
                    URL("https://sprakkraft.org/lingvis-sdk/readium/${version}").openStream().use { inp ->
