# Changelog: Readium Kotlin Toolkit with Integrated LingVis SDK

## LingVis SDK ver 1.3.1

#### Added

* Added signOut.

* Added autogenerated option to signIn.

#### File names

* Renamed poly-core.js/html to lingVisSdk.js/html.

#### Documentation

* Explained in detail the three supported options for end user sign-in.


# Changelog: Readium Kotlin Toolkit
